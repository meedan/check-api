...
module SmoochBotTestHelper
  ...
  class Menu
    def initialize(pm_for_menu_option_id, resource_uuid)
      @pm_for_menu_option_id = pm_for_menu_option_id
      @resource_uuid = resource_uuid
    end

    def smooch_custom_settings
      {
        'smooch_state_main' => {
    ...
    def add_default_language(settings)
      settings['smooch_workflows'][0].merge!(self.smooch_custom_settings)
    end
