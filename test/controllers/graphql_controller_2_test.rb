...
class GraphqlController2Test < ActionController::TestCase
  ...
  test "should get team tasks" do
    ...
    query = "query GetById { team(id: \"#{t.id}\") { team_tasks { edges { node { label, dbid, type, order, description, options, project_ids, team_id, team { slug } } } } } }"
    post :create, query: query, team: t.slug
  ...
  # Please add new tests to test/controllers/graphql_controller_3_test.rb
end
