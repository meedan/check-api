...
class SmoochPingWorkerTest < ActiveSupport::TestCase
  def setup
    ...
    @bot = create_team_bot name: 'Smooch', login: 'smooch', set_approved: true, set_settings: settings
    ...
    @installation = create_team_bot_installation user_id: @bot.id, settings: settings
