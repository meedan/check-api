...
class AbilityTest < ActiveSupport::TestCase
  ...
  test "should get permissions" do
    ...
    with_current_user_and_team(u, t) do
      assert_equal ["create TagText", "read Team", "update Team", "destroy Team", "empty Trash", "create Project", "create Account", "create TeamUser", "create User", "create Contact", "create ProjectMedia", "invite Members"].sort, JSON.parse(t.permissions).keys.sort
