...
class Bot::FetchTest < ActiveSupport::TestCase
  def setup
    ...
    WebMock.stub_request(:get, 'http://fetch:8000/claim_reviews?end_time=2017-08-10&offset=0&per_page=1000&service=test&start_time=2017-08-09').to_return(body: [@claim_review].to_json)
  ...
  test "should import claim reviews with report and correct status and ignore duplicates" do
    ...
    WebMock.stub_request(:get, 'http://fetch:8000/claim_reviews?end_time=2017-08-10&offset=0&per_page=1000&service=foo&start_time=2017-08-09').to_return(body: [cr1, cr1, cr2, cr3].to_json)
