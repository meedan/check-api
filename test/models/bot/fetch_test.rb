...
class Bot::FetchTest < ActiveSupport::TestCase
  def setup
    ...
    WebMock.stub_request(:get, 'http://fetch:8000/claim_reviews?end_time=2017-08-10&include_raw=false&offset=0&per_page=100&service=test&start_time=2017-08-09').to_return(body: [@claim_review].to_json)
