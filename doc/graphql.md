    ...
    "root": {
      "accounts": {
        "edges": [
          {
            "node": {
              "url": "http://IDMREYVZWK.com"
            }
          },
          {
            "node": {
              "url": "http://YKIFEKWZNW.com"
            }
          }
        ]
      }
...
```graphql
mutation update { updateComment(input: { clientMutationId: "1", id: "Q29tbWVudC9BVllUanl2TDVjcG1wUlhNQXg4cg==
    ...
    "root": {
      "comments": {
        "edges": [
          {
            "node": {
              "text": "ORBBNVGPRQUXLSDDMBBPCDIGDBVRGLSHQLDVSRUXMNHIOCHKLE"
            }
          },
          {
            "node": {
              "text": "ZZYCKFBAQOTACHZRVXRORNDVOWFUDPSGVESEBVLWGVULWXNWOF"
            }
          }
        ]
      }
...
```graphql
mutation destroy { destroyComment(input: { clientMutationId: "1", id: "Q29tbWVudC9BVllUajAyeDVjcG1wUlhNQXg4dQ==
" }) { deletedId } }
```
...
```json
{
  "data": {
    "destroyComment": {
      "deletedId": "Q29tbWVudC9BVllUajAyeDVjcG1wUlhNQXg4dQ==\n"
    }
  }
}
```
...
```json
{
  "data": {
    "createComment": {
      "comment": {
        "id": "Q29tbWVudC9BVllUajFxWTVjcG1wUlhNQXg4dg==\n"
      }
    }
  }
}
    ...
    "root": {
      "medias": {
        "edges": [
          {
            "node": {
              "url": "http://OIBJWWGBBB.com"
            }
          },
          {
            "node": {
              "url": "http://RFQFHONPZT.com"
            }
          }
        ]
      }
    ...
    "root": {
      "users": {
        "edges": [
          {
            "node": {
              "email": "vprgyzwxva@klziuuzokl.com"
            }
          },
          {
            "node": {
              "email": "dswjwqcsmg@cocxjxqxkz.com"
            }
          }
        ]
      }
