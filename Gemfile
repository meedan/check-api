...
gem 'i18n-generators'
gem 'rails-i18n', git: 'https://github.com/svenfuchs/rails-i18n.git', branch: 'rails-5-x', ref: 'fa7e382'
gem 'ruby-cldr'
gem 'twitter'
gem 'twitter-text'
gem 'request_store'
...
gem 'redis-rails'
gem 'activejob', '5.2.6.3'
gem 'actionmailer', '5.2.6.3'
...
gem 'partitioned', git: 'https://github.com/AirHelp/partitioned', branch: 'rails-5-2'
