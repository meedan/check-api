  ...
  module V1
    class GraphqlController < Api::V1::BaseApiController
      ...
      def create
        ...
        begin
          query = GraphQL::Query.new(RelayOnRailsSchema, query_string, variables: query_variables, debug: debug, context: { origin: request.headers['origin'], ability: @ability, file: request.params[:file] })
