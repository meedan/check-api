module FacebookAuthentication
  ...
  def setup_facebook
    ...
    request.env['omniauth.strategy'].options[:scope] = 'pages_manage_metadata,manage_pages,pages_messaging,instagram_manage_messages,instagram_basic,pages_utility_messaging' if params[:context] == 'smooch'
