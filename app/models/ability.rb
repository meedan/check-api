class Ability
  ...
  def collaborator_perms
    can [:cud, :bulk_update], Relationship, { source: { team_id: @context_team.id }, target: { team_id: @context_team.id } }
    ...
    can [:create, :update, :read], FactCheck, { claim_description: { project_media: { team_id: @context_team.id } } }
