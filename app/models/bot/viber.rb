class Bot::Viber < ActiveRecord::Base
  ...
  DynamicAnnotation::Field.class_eval do
    ...
    def update_elasticsearch_status
      self.update_media_search(['status'], { 'status' => self.value }, self.annotation.annotated) if self.field_name == 'translation_status_status' && CONFIG['app_name'] === 'Bridge'
    end
