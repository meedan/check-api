class Bot::Alegre < BotUser
  ...
  def self.throw_airbrake_notify_if_bad_relationship(relationship, score_with_context, relationship_type)
    if relationship.model.nil? || relationship.weight.nil? || relationship.source_field.nil? || relationship.target_field.nil? || ![MEAN_TOKENS_MODEL, INDIAN_MODEL, ELASTICSEARCH_MODEL, 'hash'].include?(relationship.model)
