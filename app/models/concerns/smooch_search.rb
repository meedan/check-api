...
module SmoochSearch
  ...
  module ClassMethods
    ...
    def send_explainer_to_user(ex_item_id, tipline_request, report)
      ...
      self.save_smooch_response(last_smooch_response, tipline_request.associated, data['received'], 'fact_check_report', tipline_request.language, { explainer_id: ex_item_id })
