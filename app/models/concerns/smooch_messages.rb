...
module SmoochMessages
  ...
  module ClassMethods
    ...
    def subscription_message(uid, language)
      ...
      status = subscribed ? I18n.t(:smooch_message_subscription_header_subscribed, locale: language) : I18n.t(:smooch_message_subscription_header_unsubscribed, locale: language)
    end
