class Comment < ActiveRecord::Base
  ...
  notifies_slack on: :save,
                 ...
                 message: proc { |c| data = c.annotated.embed; "*#{User.current.name}* added a note on <#{c.origin}/#{c.annotated.project.team.slug}/project/#{c.annotated.project_id}/media/#{c.annotated_id}|#{data['title']}>\n> #{c.text}" },
