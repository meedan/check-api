AccountType = GraphqlCrudOperations.define_default_type do
  ...
  connection :medias, -> { MediaType.connection_type }, 'Items published by this account'
  field :metadata, JsonStringType, 'Account metadata'
  ...
  field :user, UserType, 'Record creator'
end
