module Types
  class PublicTeamType < DefaultObject
    ...
    field :trash_count, Integer, null: true, resolve: -> (team, _args, _ctx) { archived_count(team) ? 0 : team.trash_count }
    field :unconfirmed_count, Integer, null: true, resolve: -> (team, _args, _ctx) { archived_count(team) ? 0 : team.unconfirmed_count }
    field :spam_count, Integer, null: true, resolve: -> (team, _args, _ctx) { archived_count(team) ? 0 : team.spam_count }
