module TagMutations
  ...
  Create, Update, Destroy, BulkCreate = GraphqlCrudOperations.define_crud_operations('tag', create_fields, update_fields, ['source', 'project_media', 'team', 'tag_text_object'])
end
