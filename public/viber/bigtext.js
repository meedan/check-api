    ...
    BigText = {
      ...
      jQueryMethod: function(options) {
        ...
        this.each(function() {
          ...
          $headCache.append(
            BigText.generateCss(id, sizes.fontSizes, sizes.wordSpacings, sizes.minFontSizes)
          );
        });
  ...
  function testLineDimensions($line, maxWidth, property, size, interval, units, previousWidth) {
    ...
    if (width >= maxWidth) {
      ...
      return {
        ...
        size: parseFloat(
          (parseFloat(size) -
            (property === 'word-spacing' && previousWidth && over < under ? 0 : interval)).toFixed(
            3
          )
        ),
      };
    ...
    $children
      ...
      .each(function(lineNumber) {
        ...
        for (var m = 1, n = 3; m < n; m += interval) {
          maxWordSpacing = testLineDimensions(
            $line,
            maxWidth,
            'word-spacing',
            m,
