...
namespace :check do
  namespace :migrate do
    ...
    task update_main_shared_feed_feed_team: :environment do
      ...
      FeedTeam.find_each do |feed_team|
        ...
        feed = Feed.find(id: feed_team.feed_id)
        ...
        feed_team.save!
        puts "[#{Time.now}] Updated feed_team for feed ID: #{feed.id}, Team ID: #{feed_team.team_id}."
      end
