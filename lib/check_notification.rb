module CheckNotification
  class InfoCodes
    ...
    ALL = %w(SENT_TO_TRASH_BY_RULE MOVED_TO_PROJECT_BY_RULE BANNED_SUBMITTER_BY_RULE COPIED_TO_PROJECT_BY_RULE RELATED_TO_CONFIRMED_SIMILAR RELATED_TO_SUGGESTED_SIMILAR SENT_MESSAGE_TO_REQUESTORS_ON_STATUS_CHANGE)
  end
