Dynamic.class_eval do
  def add_update_elasticsearch_dynamic_annotation_task_response_datetime(op)
    ...
    add_update_nested_obj({op: op, nested_key: 'dynamics', keys: [:datetime, :indexable], data: data})
  end
end
