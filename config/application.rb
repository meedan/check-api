...
module Check
  class Application < Rails::Application
    ...
    if cfg['locale'].blank?
      config.i18n.available_locales = ["ar","fr","pt","ro_RO","ru","es","en"] # Do not change manually! Use `rake transifex:languages` instead, or set the `locale` key in your `config/config.yml`
    else
