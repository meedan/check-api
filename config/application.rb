...
module Check
  class Application < Rails::Application
    ...
    if locale.blank?
      config.i18n.available_locales = ["ar","bho","bn","fil","fr","de","hi","id","kn","ku","ml","mr","pa","pt","ro","ru","es","sw","ta","te","ur","en","am","as","bn_BD","gu","ks","ne","si","tl"] # Do not change manually! Use `rake transifex:languages` instead, or set the `locale` key in your `config/config.yml`
    else
