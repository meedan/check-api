...
RUN apt-get update -qq && apt-get install -y vim libpq-dev nodejs graphviz inkscape imagemagick wget redis-server --no-install-recommends && rm -rf /var/lib/apt/lists/*
