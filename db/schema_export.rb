# encoding: UTF-8
#
# This is a MANUALLY maintained schema file, created to facilitate exporting a Check team data
# to a SQLite database.
#
# To load the schema, use the following line:
# ActiveRecord::Tasks::DatabaseTasks.load_schema_for({ adapter: 'sqlite3', database: 'o.db' }, :ruby, 'db/schema_export.rb')
#
...
ActiveRecord::Schema.define(version: 20200527050224) do
  ...
  add_index "account_sources", ["account_id", "source_id"], name: "index_account_sources_on_account_id_and_source_id", using: :btree
  ...
  add_index "accounts", ["url"], name: "index_accounts_on_url", using: :btree
  ...
  add_index "assignments", ["assigned_id", "assigned_type", "user_id"], name: "index_assignments_on_assigned_id_and_assigned_type_and_user_id", using: :btree
  ...
  add_index "bounces", ["email"], name: "index_bounces_on_email", using: :btree
  ...
  add_index "dynamic_annotation_fields", ["value"], name: "translation_request_id", using: :btree
  ...
  add_index "medias", ["url"], name: "index_medias_on_url", using: :btree
  ...
  add_index "project_media_projects", ["project_media_id", "project_id"], name: "index_team_media_projects_on_team_media_id_and_project_id", using: :btree
  ...
  add_index "project_medias", ["project_id", "media_id"], name: "index_project_medias_on_project_id_and_media_id", using: :btree
  ...
  add_index "relationships", ["source_id", "target_id", "relationship_type"], name: "relationship_index", using: :btree
  ...
  add_index "shortened_urls", ["unique_key"], name: "index_shortened_urls_on_unique_key", using: :btree
  ...
  add_index "tag_texts", ["text", "team_id"], name: "index_tag_texts_on_text_and_team_id", using: :btree
  ...
  add_index "teams", ["slug"], name: "unique_team_slugs", using: :btree
